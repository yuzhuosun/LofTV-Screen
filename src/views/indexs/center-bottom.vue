...
<template>
	...
	<div v-if="pageflag" class="right_center_wrap beautify-scroll-def" :class="{ 'overflow-y-auto': !sbtxSwiperFlag }">
			<!-- <div style="height: 40px;margin-top:-10px;">电梯编号 所属地址</div> -->
			...
			<ul class="right_center ">
				<li class="right_center_item" v-for="(item, i) in list" :key="i">
					...
					<div class="inner_right">
						...
						<div class="flex">
							<div class="info">
								<!-- <span class="labels ">电梯编号：</span> -->
								<span class="contents zhuyao"> {{ item.gatewayno }}</span>
							</div>

							<div class="info">
								<!-- <span class="labels"> 所属地址：</span> -->
								<span class="contents ciyao" style="font-size:12px">
									{{ item.cityName }}/{{ item.countyName }}</span>
							</div>

							<div class="info">
								<!-- <span class="labels">上报内容：</span> -->
